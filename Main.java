...
public class Main {
	...
	public static void main(String[] args) {
		...
		voters = Voting.generateVoterCircles(1000, 5, 1, -5, 0);
		voters.addAll(Voting.generateVoterCircles(1000, 5, 1, 5, 0));
		System.out.println(Voting.graphVoters(voters, 1));
		
		List<Candidate> candidates = new ArrayList<Candidate>();
		candidates = Voting.generateRandomCandidates(5);
		candidates.add(new Candidate("Centrist", 0, 0));
		...
		System.out.println();
		System.out.println("Positive-Negative voting:");
		System.out.println(Voting.positiveNegative(voters, candidates) + " wins.");
		System.out.println();
